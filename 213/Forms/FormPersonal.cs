    ...
    public partial class FormPersonal : Form
    {
        ...
        public class DBOperation
        {
            ...
            public void GetListStaff(BindingSource bs1, DataGridView dg1)
            {
                ...
                string commandStr = "SELECT id AS 'ID', fio AS 'Тип', number AS 'Название', mail AS 'Количество' FROM personal";
            ...
            public void InsertStaff(TextBox textBox1, TextBox textBox2, TextBox textBox3, TextBox textBox4)
            {
                ...
                if (textBox1.Text.Length > 0)
                {
                    ...
                    string sql_insert_clothes = " INSERT INTO `personal` (id, fio,number,mail) " +
            ...
            public void UpdateStaff(TextBox textBox1, TextBox textBox2, TextBox textBox3, TextBox textBox4)
            {
                ...
                string SQL_izm = "UPDATE personal SET id=N'" + textBox1.Text + "', fio=N'" + textBox2.Text + "', number=N'" + textBox3.Text + "'," +
